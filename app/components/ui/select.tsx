...
>(({ className, children, position = 'popper', ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        'relative z-50 max-h-96 min-w-[8rem] overflow-hidden rounded-lg border border-gray-600 bg-gray-700 text-gray-50 shadow-md',
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      'flex w-full cursor-pointer select-none items-center justify-between gap-4 rounded px-2 py-1 outline-none transition-colors focus:bg-gray-400/15 focus:text-gray-50 data-[disabled]:pointer-events-none data-[state=checked]:bg-primary-400/30 data-[disabled]:opacity-50',
      className,
    )}
    {...props}
  >
